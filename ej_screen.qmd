...
subtitle: "Cancer Risk in California’s East Bay"
author: "Jay Kim"
execute: 
  echo: true
  warning: false
...
pacman::p_load(tidyverse, sf, stars, tmap, here, viridisLite)
```
...
st_write(california, 
         here("data", "ejscreen", "california.gpkg"), 
         delete_dsn = TRUE)
st_write(east_bay_ejscreen, 
         here("data", "ejscreen", "east_bay_ejscreen.gpkg"), 
         delete_dsn = TRUE)
```
